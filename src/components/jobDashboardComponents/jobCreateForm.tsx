...
export interface TestDetails {
  ...
  passing_grade: number; // Minimum grade required to pass
  duration: number; // Duration of the test in minutes
  created_at: string; // ISO string of when the test was created
  _count: {
    testQuestions: number; // Count of questions in the test
  };
}
...
const CreateJobForm: React.FC<CreateJobFormProps> = ({
  ...
  const [preSelectionTests, setPreSelectionTests] = useState<TestDetails[]>([]);
