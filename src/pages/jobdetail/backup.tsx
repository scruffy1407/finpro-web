...
// 	useEffect(() => {
// 		console.log("Job ID:", job_id); // Log job_id to verify it's being passed

// 		if (!job_id) {
// 			return; // Prevent making a request if job_id is not available
// 		}
...
// 				);
// 				console.log("Job Data:", response.data); // Log the response data
...
// 		fetchJobDetail();
// 	}, [job_id]); // Only run effect if job_id changes
...
// 	// Ensure jobData is available before rendering the JSX
// 	if (!jobData) {
...
// 						Job expires on:{" "}
// 						<span className="text-red-500">{jobData?.expired_date}</span>
// 					</p>
// 				</div>
// 			</div>
...
// 									<p className="font-bold text-neutral-900">
// 										{jobData?.job_experience_min} -{" "}
// 										{jobData?.job_experience_max} Years
// 									</p>
// 								</div>
// 							</div>
...
// 									<p className="font-bold text-neutral-900">
// 										{jobData?.salary_min} Jt - {jobData?.salary_max} Jt
// 									</p>
// 								</div>
// 							</div>
...
// 						<div className="mb-8">{jobData?.job_description}</div>
// 					</div>
// 				</div>
...
// 						{jobData?.company?.company_industry}
// 					</h3>
