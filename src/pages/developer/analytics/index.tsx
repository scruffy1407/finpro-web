      ...
      <main className="px-4">
        <div className="p-8 space-y-6 mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {genderData && (
              <div className="w-full lg:w-4/5 mx-auto text-center">
                ...
                <div className="relative w-full max-w-xs mx-auto">
                  <Doughnut
                    data={{
                      labels: ["male", "female", "other", "Data Not Provided"],
                      datasets: [
                        {
                          data: [
                            genderData.find((item) => item.gender === "male")
                              ?._count._all || 0,
                            genderData.find((item) => item.gender === "female")
                              ?._count._all || 0,
            ...
            {ageGroupData && (
              <div className="w-full mx-auto text-center">
                <h2 className="text-2xl font-semibold py-4">Age Groups</h2>
          ...
          {locationProvinceData && (
            <div className="w-full h-full lg:w-3/4 mx-auto text-center">
              <h2 className="text-2xl font-semibold py-4">
                Location (Province)
              </h2>
              <Bar
